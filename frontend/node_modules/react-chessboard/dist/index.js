...
function Piece({ isPremovedPiece = false, piece, square, squares, }) {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ ref: arePiecesDraggable ? (canDrag ? drag : null) : null, onClick: () => onPieceClick(piece), style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? (chessPieces[piece]({
